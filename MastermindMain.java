...
public class MastermindMain {
	...
	public static void main(String[] args) { // methode
		...
		while (invoer.equals(randomCode) == false) { // checken of het NIET gelijk is, er wordt dus gespeeddd
			...
			int nettoAantalletters = computerhandelingen.alleenlettergoed(randomCode, invoer)
					- computerhandelingen.goedepositie(randomCode, invoer);
			System.out.println("Aantal ingevoerde letters dat goed is geraden, maar op een verkeerde plek staat: "
					+ nettoAantalletters);
			System.out.println("===========================");
